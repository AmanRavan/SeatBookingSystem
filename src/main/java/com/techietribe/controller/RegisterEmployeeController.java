...
public class RegisterEmployeeController {
	...
	public ResponseEntity<?> employeeLogin(@RequestBody Employee employee) {
      ...
      public Employee loginUser(@RequestBody Employee user) throws Exception{
          ...
          if(tempEmailId!=null && tempPassword!=null) {
              user2=employeeDaoImplementation.findByEmailIdAndPassword(tempEmailId, tempPassword);
          }
          if(user2==null) {
	...
	public String processForgotPasswordForm(@RequestBody Employee employee, HttpServletRequest request) {
		Optional<Employee> optional = employeeDaoImplementation.findEmployeeByEmailId(employee.getEmailId());
	...
	///Akhiesh made changes
	// Display form to reset password
	@RequestMapping(value = "/reset", method = RequestMethod.GET)
	public String displayResetPasswordPage(@RequestBody Employee employee, String token) {
	...
	public String setNewPassword(@RequestBody Map<String, String> requestParams) {
